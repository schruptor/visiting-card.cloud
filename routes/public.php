...
use App\Http\Controllers\Card\DownloadController as CardDownloadController;
...
Route::get('/card/download/{card}', CardDownloadController::class)->name('card.download');
